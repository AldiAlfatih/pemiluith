      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="bg-gradient-to-br from-slate-900 to-[#0A0F24] rounded-3xl p-8 text-white relative overflow-hidden shadow-xl shadow-slate-900/20 w-full">
          ...
          <Link 
            ...
            className="inline-flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-xl transition-colors relative z-10"
          >
