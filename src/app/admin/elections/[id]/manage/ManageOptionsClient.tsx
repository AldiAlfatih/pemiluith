            ...
            <div key={o.id} className={`bg-white border p-4 rounded-2xl flex flex-col justify-between ${!o.isActive ? 'border-red-200 opacity-75' : 'border-slate-200'}`}>
              ...
              <div className="flex gap-2 mt-4 pt-4 border-t border-slate-100">
                ...
                <button 
                  ...
                  disabled={loading}
                  className={`flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg text-xs font-semibold transition-colors disabled:opacity-50 ${o.isActive ? 'bg-amber-50 hover:bg-amber-100 text-amber-600' : 'bg-green-50 hover:bg-green-100 text-green-600'}`}
                >
